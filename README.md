...
- **Automatic failover** - Falls back to cloud storage when Redis is unavailable
- **AI Intelligence** - Real vector embeddings, entity extraction, knowledge graphs
...
- **Zero configuration** - Just run `npx @n3wth/r3` to get started

### AI Intelligence Features (v1.3.0)
...
r3 automatically starts with an embedded Redis server. No setup required.
...
r3 includes advanced AI capabilities that automatically enhance your memory storage:
